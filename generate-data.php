...
for ($a = 0; $a < 10; $a++) {
	...
	echo "<br>";
	echo '"nama_instansi": ' . ($instansi[$num_instansi]['nama_instansi'] != '') ? $instansi[$num_instansi]['nama_instansi'] : "" . ',';
	echo "<br>";
	echo '"alamat_instansi": ' . ($instansi[$num_instansi]['alamat_instansi'] != '') ? $instansi[$num_instansi]['alamat_instansi'] : "" . ',';
	echo "<br>";
	echo '"notelp_instansi": ' . ($instansi[$num_instansi]['telp_instansi'] != '') ? $instansi[$num_instansi]['telp_instansi'] : "" . ',';
	echo "<br>";
	echo "},";
	echo "<br>";
}
